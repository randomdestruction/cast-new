...
def search(query=None):
    ...
    results = None
    if query:
#this is slow and stupid.  add a reindex function elsewhere
#until then, uncomment this after a fresh install that uses an existing
#database
#        whooshee.reindex()
        results = Pick.query.whooshee_search(query).all()
